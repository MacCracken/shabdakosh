...
- [x] Test coverage adequate for the surface area (873 assertions / 26 suites, all green — 689 at
      the 3.0.0 release gate, +132 regressions from the 3.0.4 P1 sweep, +52 from the 3.0.5 backlog sweep)
